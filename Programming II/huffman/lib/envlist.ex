defmodule EnvList do
  ...
  def memberval([], _) do nil end
  def memberval([{key, value} | _], value) do {key, value} end
  def memberval([_ | t], value) do memberval(t, value) end
  ...
  def lookupval(map, value) do memberval(map, value) end
  ...
  def lowest([h | t]) do lowest([h | t], h) end
  def lowest([], acc) do acc end
  def lowest([{key, value} | t], {key2, curlowest}) do
    if value < curlowest do
      lowest(t, {key, value})
    else
      lowest(t, {key2, curlowest})
    end
  end
